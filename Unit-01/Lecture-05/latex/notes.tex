...
\begin{itemize}
  ...
  \end{itemize}
\subsection*{Decision Making: \texttt{if/elif/else}}
\begin{lstlisting}[language=Python]
marks = int(input("Marks: "))
if marks >= 90:
    print("A+")
    ...
    print("Needs improvement")
  \end{lstlisting}
\subsection*{Nested \texttt{if} (Example)}
\begin{lstlisting}[language=Python]
age = int(input("Age: "))
if age >= 18:
    if age >= 60:
...
match day:
    ...
    case _:
        print("Other day")
  \end{lstlisting}
\subsection*{Loops: \texttt{for} with \texttt{range}}
\begin{itemize}
...
\begin{itemize}
  ...
  \end{itemize}
\subsection*{\texttt{else} with a \texttt{for} Loop}
\begin{lstlisting}[language=Python]
for i in range(1, 6):
    if i == 3:
        break
  ...
  \end{itemize}
\subsection*{Demo: Menu-Driven Program}
\begin{itemize}
