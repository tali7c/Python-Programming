...
\begin{frame}[fragile]{Functions in Real-world Applications}
  \begin{itemize}[<+->]
...
\begin{frame}[fragile]{Scope: LEGB (Local/Enclosed/Global/Built-in)}
  \begin{itemize}[<+->]
...
\begin{frame}[fragile]{Passing Data: Mutable vs Immutable}
  \begin{itemize}[<+->]
